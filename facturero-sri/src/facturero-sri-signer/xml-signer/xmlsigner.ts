...
export class XmlSigner {
    ...
    signXml(p12Buffer: Buffer<ArrayBuffer>, password: string, xmlBuffer: string): string {
    ...
    loadPrivateKey(p12Buffer: Buffer<ArrayBuffer>, password: string): { privateKey: string; certificate: string } {
